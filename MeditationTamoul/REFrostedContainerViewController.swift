 ...
 */
class REFrostedContainerViewController: UIViewController {
    // structure
    weak var hamburguerViewController: REFrostedViewController!      // root hamburguer view controller
    ...
    override func viewDidLoad() {
        ...
        let gestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(REFrostedContainerViewController.tapGestureRecognized(_:)))
